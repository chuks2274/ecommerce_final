...
describe("CartItemCard", () => {
    it("renders item details correctly", () => {
        render(_jsx(CartItemCard, { item: mockItem, onDecrease: jest.fn(), onIncrease: jest.fn(), onRemove: jest.fn() }));
    ...
    it("calls callbacks when buttons are clicked", () => {
        ...
        render(_jsx(CartItemCard, { item: mockItem, onDecrease: onDecrease, onIncrease: onIncrease, onRemove: onRemove }));
