...
export async function sendNotification(status, estimatedDeliveryDate) {
    ...
    switch (status) {
        case "in process":
            ...
            message = `📦 Your order is being processed${estimatedDeliveryDate
        ...
        case "pending":
            ...
            message = `⏳ Your order is pending confirmation${estimatedDeliveryDate
                ? ` and estimated for delivery on ${estimatedDeliveryDate}`
                : ""}.`;
            type = "info";
            break;
