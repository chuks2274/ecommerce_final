import { createSlice, createAsyncThunk, } from "@reduxjs/toolkit"; // Import Redux Toolkit functions to create slices, async actions, and typed action payloads
...
export const fetchAndSetUser = createAsyncThunk("auth/fetchAndSetUser", async (firebaseUser, thunkAPI) => {
    if (!firebaseUser)
